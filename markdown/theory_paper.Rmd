...
subtitle: ""
author: Kevin Morris^[PhD Student, Department of Sociology, CUNY Graduate Center (kmorris@gradcenter.cuny.edu)]
...
# Data and Hypotheses {.unnumbered}
...
```{r mef2-c, echo = FALSE, message = F, warning = F, fig.width = 7.5, fig.height = 5, fig.cap = "\\label{fig:mef2}Predicted Behavior of Conservatives, 2020 Election", fig.pos = "H", fig.align = "center"}
...
```{r mef3-c, echo = FALSE, message = F, warning = F, fig.width = 7.5, fig.height = 5, fig.cap = "\\label{fig:mef3}Predicted Trump Support Among Conservative Participants, 2020 Election", fig.pos = "H", fig.align = "center"}
